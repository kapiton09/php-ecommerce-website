<div class="collapse navbar-collapse navbar-ex1-collapse">
    <ul class="nav navbar-nav side-nav">
        ...
        <li>
            <a href="index.php?suppliers"><i class="fa fa-fw fa-desktop"></i> Suppliers</a>
        </li>
        <li>
            <a href="index.php?customers"><i class="glyphicon glyphicon-user"></i> Customers</a>
        </li>

        <li>
            <a href="index.php?slides"><i class="glyphicon glyphicon-camera"></i> Slides</a>
        </li>

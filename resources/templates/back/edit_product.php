...
if (isset($_GET['id'])){
    ...
    while ($row = fetch_array($query)){
        ...
        $product_supplier_id = escape_string($row['product_supplier_id']);
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="col-md-8">
            ...
            <div class="form-group">
                ...
                <textarea name="short_desc" id="" cols="15" rows="3" class="form-control"><?php echo $short_desc; ?></textarea>
            </div>
        ...
        <aside id="admin_sidebar" class="col-md-4">
            ...
            <div class="form-group">
                ...
                <select name="product_supplier_id" id="" class="form-control">
                    <option value="<?php echo $product_supplier_id?>""><?php echo show_product_supplier_title($product_supplier_id); ?></option>
            ...
            <div class="form-group">
                ...
                <img height="100px" src="../../resources/<?php echo display_image($product_image); ?>">
